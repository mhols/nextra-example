...
class SettingsReference:
    ...
    BASEDIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../my_setupfiles"))
    REFFILES = os.path.abspath(os.path.join(BASEDIR, "reffiles"))
    REFTHARFILE = os.path.abspath(
        os.path.join(REFFILES, "ref_neonarval/NEO_20220903_191404_th0.fits")
    )
    ...
    SHIFT_MASK_VOIE2 = list(
        range(-VOIE2WIDTH - 1, 0)
